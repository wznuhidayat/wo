<html lang="en">
  ...
  <body id="page-top">
    ...
    <script type="text/JavaScript" src="<?= base_url() ?>assets/bootstrap-4/js/jquery.easing.1.3.js"  crossorigin="anonymous"></script> --><!--  --> -->
    <script type="text/JavaScript" src="<?= base_url() ?>assets/bootstrap-4/skin/style.js"  crossorigin="anonymous"></script> --><!--  -->
